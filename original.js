...
const apiConfig = {
  ...
  // uploadEndpoint:"https://71e3-2c0f-f5c0-b08-1637-b0e0-db8c-cd80-6ed6.ngrok-free.app/api/generate-images",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const personalizationButton = document.getElementById("personalize-button");
  ...
  if (!productForm || !personalizationContainer || !personalizationButton)
    return;
  ...
  function getCurrentTemplate() {
    ...
    return templates[numberOfKids] || templates[1];
  }
  ...
  if (personalizationButton) {
    personalizationButton.addEventListener("click", function () {
      const isCustomizerVisible = !customizerWrapper.classList.contains("hide");

      // Toggle visibility
      customizerWrapper.classList.toggle("hide", isCustomizerVisible);
      galleryWrapper.classList.toggle("hide", !isCustomizerVisible);
      personalizationFields.style.display = isCustomizerVisible
        ? "none"
        : "block";

      // When showing personalization fields, replace the single button with two buttons
      if (!isCustomizerVisible) {
        // Hide the original personalize button
        personalizationButton.style.display = "none";
        ...
        cancelButton.addEventListener("click", function () {
          ...
          // Show the original personalize button again
          personalizationButton.style.display = "block";
  ...
  // Make functions available globally to be called from other scripts
  window.generatePrintImage = generatePrintImage;
